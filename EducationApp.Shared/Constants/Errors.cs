namespace EducationApp.Shared.Constants
{
    public partial class Constants
    {
        ...
        public const string ORDERNOTFOUNDERROR = "Requested order(s) don't exist";
        public const string PRINTINGEDITIONNOTFOUNDERROR = "Requested printing edition(s) don't exist";
        public const string PRINTINGEDITIONISNOTINCARTERROR = "Printing edition was not added to cart";
